...
# Legacy aliases (sin /etl prefix). Mantienen compat con clientes viejos.
# Reusan las funciones de arriba — sin duplicación.
router.add_api_route("/last-runs",            last_runs,  methods=["GET"])
router.add_api_route("/trigger/{job_name}",   trigger_job, methods=["POST"])
router.add_api_route("/status",               etl_status, methods=["GET"])
